...
begin
   ...
   Logical_Address := 16#000e_0001_0000#;
   Subject_ID      := 1;


   if (Is_Valid_Address(i => Logical_Address, Subject_ID => Subject_ID)) then
      Physical_Address := Translate_Address(i => Logical_Address,  Subject_ID => Subject_ID);
